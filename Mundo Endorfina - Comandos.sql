...
DROP TABLE reacoes_feed; -- sub_admin, login, pessoas, redes_sociais, historico_postagens, metas, historico_metas, pontos_usuarios, cupons, feed_usuario, reacoes_feed, meu_feed, dashboard_subadmin;
