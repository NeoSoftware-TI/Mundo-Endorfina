...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // If we're opening the sidebar, make sure it's not hidden
      if (openState) {
        setHidden(false)
      }
    },
  ...
  const state = hidden ? "hidden" : open ? "expanded" : "collapsed"
  ...
  const contextValue = React.useMemo<SidebarContext>(
    ...
    [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, hideSidebar],
  )
